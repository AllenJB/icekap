...
void Theme_Config::loadSettings()
{
    ...
    m_dirs = KGlobal::dirs()->findAllResources("data","icekap/themes/*/index.desktop");
...
void Theme_Config::installTheme()
{
    KURL themeURL = KFileDialog::getOpenURL(QString::null,
        i18n("*.tar.gz *.tar.bz2 *.tar *.zip|Icekap Themes"),
        NULL,
    ...
    QString themesDir(locateLocal("data", "icekap/themes/"));
