...
int KonversationMainWindow::confirmQuit()
{
    ...
    int result=KMessageBox::warningContinueCancel(
        this,
        i18n("<qt>Are you sure you want to quit <b>Icekap</b>?</qt>"),
        i18n("Confirm Quit"),
        i18n("Quit"),
...
bool KonversationMainWindow::queryClose()
{
    ...
    if (Preferences::showTrayIcon() && !m_closeApp)
    {
        KMessageBox::information( this,
            i18n("<p>Closing the main window will keep Icekap running in the system tray. "
            "Use <b>Quit</b> from the <b>Icekap</b> menu to quit the application.</p>"),
